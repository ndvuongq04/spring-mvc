                                    ...
                                    <div class="row">
                                        <div class="col-12 mx-auto">
                                            <div class="d-flex justify-content-between">
                                                <h3>Table products id = ${id}</h3>
                                            </div>

                                            <hr />
                                            <div class="card" style="width: 60%;">
                                                <img class="card-img-top" src="/images/product/${productGoDetail.image}"
                                                    alt="ảnh product ${productGoDetail.id} ">
                                            </div>
                                            <div class="card" style="width: 60%;">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item">Id : ${productGoDetail.id}</li>
                                                    <li class="list-group-item">Name : ${productGoDetail.name}</li>
