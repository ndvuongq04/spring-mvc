    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <title>Cart Detail- Laptopshop</title>
                        ...
                        <div class="mb-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-curren="page">Chi Tiết Giỏ Hàng</li>
                                </ol>
                            </nav>
                        </div>
                                ...
                                <div class="row ">
                                    <div class="col-12 mt-5">
                                        <div class="alert alert-danger" role="alert">
                                            Bạn chưa thêm sản phẩm nào vào giỏ hàng . Vui lòng thêm sản phẩm vào giỏ
                                            hàng !
                                        </div>
